...
### 1. Clone Repository
```powershell
git clone https://github.com/devadharshan-0308/A.R.G.U.S.git
cd A.R.G.U.S
```
...
MUNICIPAL_DISPATCH_EMAIL=corporationunicipal26@gmail.com
```
...
- **Project:** ARGUS — Autonomous Urban Transit Sensing & Municipal Intelligence Platform
- **Problem Statement:** Smart India Hackathon (SIH) — Autonomous Transit Surveillance & Civic Maintenance Scheduling
- **Built with:** PyTorch, Ultralytics YOLO11, OpenCV, PyQt5, Mapbox GL, EasyOCR.
