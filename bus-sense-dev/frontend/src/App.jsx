  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', backgroundColor: 'var(--bg-main)' }}>
      ...
      {connectionStatus === 'DISCONNECTED' && (
        <div style={{
          backgroundColor: 'rgba(180, 54, 59, 0.08)',
          borderBottom: '1px solid rgba(180, 54, 59, 0.3)',
          ...
          <AlertCircle size={15} color="#B4363B" />
          <span>
            Backend server not detected at <code style={{ fontFamily: 'var(--font-mono)' }}>http://localhost:8000</code>. Start it with <strong style={{ color: 'var(--text-primary)' }}>python server.py</strong> to enable real-time ingestion.
          </span>
        </div>
      )}
