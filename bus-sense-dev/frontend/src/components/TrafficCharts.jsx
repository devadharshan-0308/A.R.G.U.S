        ...
        {recentMetrics.length < 2 ? (
          ...
          <div style={{ width: '100%', height: '120px', position: 'relative' }}>
            <svg viewBox="0 0 300 100" style={{ width: '100%', height: '100%', overflow: 'visible' }}>
              ...
              {/* Grid Lines */}
              <line x1="0" y1="25" x2="300" y2="25" stroke="rgba(148, 163, 184, 0.35)" strokeDasharray="3 3" />
              <line x1="0" y1="50" x2="300" y2="50" stroke="rgba(148, 163, 184, 0.35)" strokeDasharray="3 3" />
              <line x1="0" y1="75" x2="300" y2="75" stroke="rgba(148, 163, 184, 0.35)" strokeDasharray="3 3" />
